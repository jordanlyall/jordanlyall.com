...
Adopt it? Rebuild it from scratch? Fork it and polish it? The handoff model most product orgs grew up with -- PM writes spec, design mocks it, eng builds it, QA tests it -- assumed only one function could build at a time. That's no longer true. And the new model isn't written yet.
